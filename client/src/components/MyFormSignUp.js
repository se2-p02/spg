...
function MyFormSignUp(props) {
    ...
    return (
        <>
            <Container className="bg_login min-height-100 justify-content-center align-items-center text-center p-0 pt-5" fluid>
                {registered === true && (
                    <>
                ...
                {registered === false && (
                    <>
                        <Row>
                            <Col sm="3"></Col>
                            <Col sm="6" className="mb-3 p-3 pt-0 pb-0 mt-0 mb-3" >
                            ...
                            <Row>
                                <Col sm={12}>
                                    <Form.Group controlId="email">
                                        <Form.Label className="text-black p-0 pt-3 m-0"><h6>Email</h6></Form.Label>
                                        <Form.Control
                                            type="email"
                            ...
                            <Row>
                                <Col sm="6">
                                    <Form.Group controlId="Password">
                                        <Form.Label className="text-black pt-3  m-0"><h6>Password</h6></Form.Label>
                                        <InputGroup>
                                            <Form.Control
                                ...
                                <Col sm="6">
                                    <Form.Group controlId="repeatPassword">
                                        <Form.Label className="text-black p-0 pt-3  m-0 "><h6>Repeat Password</h6></Form.Label>
                                        <InputGroup>
                                            <Form.Control
                                                type={showPassword ? "text" : "password"}
                                                className="p-2"
                            ...
                            <Row>
                                <Col sm="6">
                                    <Form.Group controlId="number">
                                        <Form.Label className="text-black p-0 pt-3  m-0"><h6>Phone Number</h6></Form.Label>
                                        <Form.Control
                                            type="tel"
                                            className="w-100 p-2"
                                ...
                                <Col sm="6">
                                    <Form.Group controlId="country">
                                        <Form.Label className="text-black p-0 pt-3  m-0"><h6>Country</h6></Form.Label>
                                        <Form.Control
                                            className="w-100 p-2"
                                            placeholder="Country"
                                            required
                            ...
                            <Row>
                                <Col>
                                    <Form.Group controlId="city">
                                        <Form.Label className="text-black p-0 pt-3  m-0"><h6>City</h6></Form.Label>
                                        <Form.Control
                                            className="w-100 p-2"
                                            placeholder="City"
                                            required
                                ...
                                <Col>
                                    <Form.Group controlId="address">
                                        <Form.Label className="text-black p-0 pt-3  m-0"><h6>Address</h6></Form.Label>
                                        <Form.Control
                                            className="w-100 p-2"
                                            placeholder="Address"
                                            required
