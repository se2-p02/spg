                ...
                <Accordion.Header>
                  <Row className="acc-header-row">
                    ...
                    <Col>{o.products.every(pr => pr.status >= 1) && !o.paid
                      ...
                      {(o.products.every(pr => pr.status >= 1) && o.paid && !(o.products.every(pr => pr.status >= 2)))
                        ? <h5><Badge pill className="mb-1 badge_conf">Confirmed by Farmers</Badge></h5>
                        : (o.products.every(pr => pr.status >= 2) && o.paid && !o.products.every(pr => pr.status >= 3))
                        && <h5><Badge pill className="mb-1 badge_confprep">In preparation</Badge></h5>}
                      ...
                      {o.status === 'available' && !o.fulfilled
                        && <h5><Badge pill bg="success" className="mb-1">Available for Pickup</Badge></h5>}</Col>
                    <Col>{o.fulfilled === 1
